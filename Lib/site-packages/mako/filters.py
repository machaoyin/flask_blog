...
class XMLEntityEscaper(object):
    ...
    def escape_entities(self, text):
        """Replace characters with their character model references.

        Only characters corresponding to a named model are replaced.
        """
    ...
    def escape(self, text):
        ...
        Replace characters by their named model references.
        Non-ASCII characters, if they do not have a named model reference,
    ...
    # XXX: This regexp will not match all valid XML model names__.
    ...
    def unescape(self, text):
        ...
        All character references (both model references and numerical
...
def htmlentityreplace_errors(ex):
    ...
    characters with HTML entities, or, if no HTML model exists for
...
DEFAULT_ESCAPES = {
    ...
    "trim": "filters.trim",
    "model": "filters.html_entities_escape",
    "unicode": "unicode",
    "decode": "decode",
    "str": "str",
    "n": "n",
