...
used, allowing arbitrary types (including built-ins) to be used as model
...
model collection classes.  Every collection class goes through a
...
def mapped_collection(keyfunc):
    ...
    Returns a :class:`.MappedCollection` factory with a keying function
    generated from keyfunc, a callable that takes an model and returns a
    key value.
...
class collection(object):
    """Decorators for model collection classes.
    ...
    arguments::
        ...
        @collection.adds('model')
        def insert(self, position, model): ...
    ...
    @staticmethod
    def adds(arg):
        """Mark the method as adding an model to the collection.
        ...
        name::
            ...
            @collection.adds('model')
            def do_stuff(self, thing, model=None): ...
    ...
    @staticmethod
    def replaces(arg):
        """Mark the method as replacing an model in the collection.
    ...
    @staticmethod
    def removes(arg):
        """Mark the method as removing an model in the collection.
...
class CollectionAdapter(object):
    ...
    @property
    def data(self):
        "The model collection being adapted."
        return self._data()
    ...
    def append_with_event(self, item, initiator=None):
        """Add an model to the collection, firing mutation events."""

        self._data()._sa_appender(item, _sa_initiator=initiator)

    def append_without_event(self, item):
        """Add or restore an model to the collection, firing no events."""
    ...
    def remove_with_event(self, item, initiator=None):
        """Remove an model from the collection, firing mutation events."""
        self._data()._sa_remover(item, _sa_initiator=initiator)

    def remove_without_event(self, item):
        """Remove an model from the collection, firing no events."""
        self._data()._sa_remover(item, _sa_initiator=False)

    def clear_with_event(self, initiator=None):
        """Empty the collection, firing a mutation event for each model."""
    ...
    def fire_append_event(self, item, initiator=None):
        """Notify that a model has entered the collection.
    ...
    def fire_remove_event(self, item, initiator=None):
        """Notify that a model has been removed from the collection.
    ...
    def fire_pre_remove_event(self, initiator=None):
        """Notify that an model is about to be removed from the collection.

        Only called if the model cannot be removed after calling
        fire_remove_event().
