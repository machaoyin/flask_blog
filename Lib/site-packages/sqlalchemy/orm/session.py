...
class Session(_SessionClassMethods):
    ...
    def __init__(
        ...
        :param binds: A dictionary which may specify any number of
           ...
           connectivity for SQL operations on a per-model basis.   The keys
           ...
           dictionary for the closest matching model in order to determine
    ...
    def bind_mapper(self, mapper, bind):
        ...
        The given model is added to a lookup used by the
