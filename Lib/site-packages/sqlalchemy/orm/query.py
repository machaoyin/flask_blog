...
class Query(object):
    ...
    def _entity_zero(self):
        """Return the 'model' (mapper or AliasedClass) associated
    ...
    def cte(self, name=None, recursive=False):
        ...
        ``Part`` model, so column-mapped attributes are available
        directly::
    ...
    def is_single_entity(self):
        ...
        Returns True if this query returns a single model for each instance
    ...
    def get(self, ident):
        ...
        i.e. against a single mapped model,
    ...
    def with_parent(self, instance, property=None, from_entity=None):  # noqa
        ...
        :param from_entity:
          ...
          "zero" model of the :class:`_query.Query` itself.
    ...
    def add_entity(self, entity, alias=None):
        """add a mapped model to the list of result columns
        to be returned."""
    ...
    def from_self(self, *entities):
        ...
        The above query joins to the ``Address`` model but only against the
        ...
        **automatic aliasing** to the entities inside the subquery, when
        ...
        refer to the ``User`` model without any additional aliasing applied
        ...
        such as referring to the model in joins should prefer to use
        ...
        **Changing the Entities**
        ...
        ``Address`` model on the outside, but we only wanted the outer
        ...
        **Looking out for Inner / Outer Columns**
        ...
        SQL.  For example, if we wanted to load from a joined model inside
        ...
        :func:`.contains_eager` to load the ``User`` model, it would be
    ...
    def with_hint(self, selectable, text, dialect_name="*"):
        ...
        hint for the given model or selectable to
    ...
    def filter_by(self, **kwargs):
        ...
        model of the query, or the last model that was the
        ...
        if zero is None:
            raise sa_exc.InvalidRequestError(
                "Can't use filter_by when the first model '%s' of a query "
    ...
    def join(self, *props, **kwargs):
        ...
        **Joins to a Target Entity or Selectable**
        ...
        A second form of :meth:`_query.Query.join` allows any mapped model or
        ...
        the target model and the model or entities already present on the
        ...
        **Joins to a Target with an ON Clause**
        ...
        The third calling form allows both the target model as well
        ...
        to join to an alias of a particular target model.  If we wanted
        ...
        The relationship-bound calling form can also specify a target model
        ...
        **Joining to Tables and Subqueries**
        ...
        which may be related to a target model or not.   Use the
        ...
        target model may be achieved by linking the subquery to the
        model using :func:`_orm.aliased`::
        ...
        * Automatic aliasing with the ``aliased=True`` flag::
          ...
          **Why it's legacy**:  the automatic aliasing feature of
          ...
          its aliasing of a target model, ``Node`` in the above case, will be
        ...
        * Multiple joins in one call::
          ...
          **Why it's legacy**: being able to chain multiple ON clauses in one
          ...
          the problem of being able to specify what model to join from,
        ...
        :param \*props: Incoming arguments for :meth:`_query.Query.join`,
         ...
         or two argument form, either as a single "target" model or ORM
         attribute-bound relationship, or as a target model plus an "on
    ...
    def _join(self, keys, outerjoin, full, create_aliases, from_joinpoint):
        ...
        for idx, arg1 in enumerate(keylist):
            ...
            if isinstance(onclause, util.string_types):
                ...
                # we look to the left model or what we last joined
                # towards
    ...
    def _join_left_to_right(
        ...
        if left is None:
            ...
            # existing model it corresponds to.
    ...
    def _join_determine_implicit_left_side(self, left, right, onclause):
        ...
        determine if an existing FROM or model in this query
        ...
        if self._from_obj:
            ...
            if len(indexes) == 1:
                ...
                raise sa_exc.InvalidRequestError(
                    ...
                    "join to this model. Please use the .select_from() "
    ...
    def _join_place_explicit_left_side(self, left):
        ...
        if self._from_obj:
            ...
            if len(indexes) > 1:
                raise sa_exc.InvalidRequestError(
                    "Can't identify which model in which to assign the "
        ...
        # aliasing / adaptation rules present on that model if any
        if (
    ...
    def _join_check_and_adapt_right_side(
        ...
        if r_info.is_clause_element:
            ...
            if right_selectable._is_lateral:
                ...
                # make the right hand side target into an ORM model
                ...
                raise sa_exc.InvalidRequestError(
                    ...
                    "with an ORM model, not a plain selectable, as the "
                    "target."
                )
    ...
    def select_from(self, *from_obj):
        ...
        :meth:`_query.Query.join` in order to control which model is selected
        from on the "left" side of the join.

        The model or selectable object here effectively replaces the
        "left edge" of any calls to :meth:`_query.Query.join`, when no
        joinpoint is otherwise established - usually, the default "join
        point" is the leftmost model in the :class:`_query.Query` object's
    ...
    def select_entity_from(self, from_obj):
        ...
        occurrences of the model to the target selectable.
        ...
        may be
        used at the start of the query to adapt the existing ``User`` model::

            q = session.query(User).\
                select_entity_from(select_stmt).\
                filter(User.name == 'ed')

        Above, the generated SQL will show that the ``User`` model is
        ...
        primary model.  If above we had used :meth:`_query.Query.select_from`
        ...
        model, which is achieved by making use of the
    ...
    def from_statement(self, statement):
        ...
        of columns
        appropriate to the model class represented by this
        :class:`_query.Query`.
    ...
    def first(self):
        ...
        only one primary model row is generated on the server side
        ...
        return [
            {
                ...
                "expr": ent.expr,
                "model": getattr(insp_ent, "model", None)
    ...
    def delete(self, synchronize_session="evaluate"):
        ...
        .. warning:: **Additional Caveats for bulk query deletes**
            ...
            * The :meth:`.MapperEvents.before_delete` and
              ...
              act upon a mass DELETE of model rows.
    ...
    def update(self, values, synchronize_session="evaluate", update_args=None):
        ...
        :param values: a dictionary with attributes names, or alternatively
         ...
         as well.
          ...
          .. versionchanged:: 1.0.0 - string names in the values dictionary
             are now resolved against the mapped model; previously, these
        ...
        .. warning:: **Additional Caveats for bulk query updates**
            ...
            * The :meth:`.MapperEvents.before_update` and
              ...
              act upon a mass UPDATE of model rows.
    ...
    def _adjust_for_single_inheritance(self, context):
        ...
        the columns clause of this query, as well as the "select from model",
...
class _QueryEntity(object):
    """Represent an model column returned within a Query result."""
...
class _MapperEntity(_QueryEntity):
    """mapper/class/AliasedClass model"""
...
class Bundle(InspectionAttr):
    ...
    model, rather than an element within a keyed tuple."""
    ...
    def __init__(self, name, *exprs, **kw):
        ...
        :param single_entity=False: if True, rows for this :class:`.Bundle`
         can be returned as a "single model" outside of any enclosing tuple
         in the same manner as a mapped model.
...
class _ColumnEntity(_QueryEntity):
    ...
    def __init__(self, query, column, namespace=None):
        ...
        if not isinstance(column, sql.ColumnElement):
            ...
            raise sa_exc.InvalidRequestError(
                "SQL expression, column, or mapped model "
