...
class Mapper(InspectionAttr):
    ...
    def __init__(
        ...
        :param passive_deletes: Indicates DELETE behavior of foreign key
           columns when a joined-table inheritance model is being deleted.
           ...
           to delete the model, it need only emit a DELETE statement for the
    ...
    def _configure_class_instrumentation(self):
        ...
        given class and model name.

        Subsequent calls to ``class_mapper()`` for the ``class_`` / ``model``
